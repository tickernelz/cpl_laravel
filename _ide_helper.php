...
')
     ...
     */
        ...
        public static function setOptions($options)
        {
                    ...
                    /**
         * Output the PDFController as a string.
         *
         * @return string The rendered PDFController as string
         * @static
         */
        public static function output()
        {
                    ...
                    /**
         * Save the PDFController to a file
         *
         * @param $filename
         * @return static
         * @static
        ...
        public static function save($filename)
        {
                    ...
                    /**
         * Make the PDFController downloadable by the user
         *
        ...
        public static function download($filename = 'document.pdf')
        {
                    ...
                    /**
         * Return a response with the PDFController to show in the browser
         *
         * @param string $filename
         * @return \Illuminate\Http\Response
         * @static
