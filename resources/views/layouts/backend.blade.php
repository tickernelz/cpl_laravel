        ...
        <div class="js-sidebar-scroll">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item{{ request()->is('admin','dosen','admin/tambah*','admin/edit/*','dosen/tambah*','dosen/edit/*') ? ' open' : '' }}">
                        ...
                        <ul class="nav-main-submenu">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dosen','dosen/tambah*','dosen/edit/*') ? ' active' : '' }}"
                                   href="{{URL::to('dosen')}}">
