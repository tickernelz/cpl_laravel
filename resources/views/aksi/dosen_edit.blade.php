                                    ...
                                    <form method="POST" class="custom-validation" action="{{url()->current()}}/post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="nip" name="nip" class="form-control"
                                                   value="{{ $dosen->nip }}" onkeyup="checkAvailability1()"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status" aria-label="Status Dosen">
                                                <option
                                                    value="Dosen Koordinator" <?php if ($dosen->user->status === "Dosen Koordinator") {
                                                    echo 'selected="selected"';
                                                } ?>>Dosen Koordinator
                                                </option>
                                                <option
                                                    value="Dosen Pengampu" <?php if ($dosen->user->status === "Dosen Pengampu") {
                                                    echo 'selected="selected"';
                                                } ?>>Dosen Pengampu
                                                </option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="username" name="username"
                                                   value="{{ $dosen->user->username }}" onkeyup="checkAvailability2()"
                                                   class="form-control" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password" value="{{ $dosen->user->password }}"
                                                   class="form-control" required>
                                        </div>
