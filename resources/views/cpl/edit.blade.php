                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-lg-10 col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input name="kode_cpl-ori" type="hidden" value="{{ $cpl->kode }}">
                                    <input type="text" class="form-control" id="kode_cpl"
                                           value="{{ $cpl->kode_cpl }}" name="kode_cpl"
                                           placeholder="Masukkan Kode Mata Kuliah..." required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="nama_cpl">Nama CPL</label>
                                    <input type="text" class="form-control" id="nama_cpl"
                                           value="{{ $cpl->nama_cpl }}" name="nama_cpl"
