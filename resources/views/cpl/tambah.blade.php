...
@section('content')
    ...
    <div class="content">
        ...
        <div class="col-md-6 " style="float:none;margin:auto;">
            <form method="POST" action="{{ route('form-tambah-cpl') }}">
                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-lg-10 col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="kode_cpl" name="kode_cpl"
                                           placeholder="Masukkan Kode CPL..." required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="nama_cpl">Nama CPL</label>
                                    <input type="text" class="form-control" id="nama_cpl" name="nama_cpl"
                                           placeholder="Masukkan Nama CPL..." required>
                                </div>
                            </div>
                        </div>
                    </div>
